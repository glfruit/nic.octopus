...
namespace Nic.Octopus.ObjectExtending
{
    public static class OctopusDomainObjectExtensions
    {
        ...
        public static void Configure()
        {
            OneTimeRunner.Run(() =>
            {
                 ...
                 * table fields in the database, then configure them in the OctopusEfCoreEntityExtensionMappings
                 *
                 * Example:
                 *
